    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='foodie1.customer')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foodie1.cart')),
                ('food', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='foodie1.food')),
            ],
        ),
        migrations.AddField(
            model_name='cart',
            name='user',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='foodie1.customer'),
        ),
